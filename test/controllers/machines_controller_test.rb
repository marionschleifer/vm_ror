...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { current_position: @machine.current_position, name: @machine.name, positions: @machine.positions }
    end
  ...
  test "should update machine" do
    patch :update, id: @machine, machine: { current_position: @machine.current_position, name: @machine.name, positions: @machine.positions }
    assert_redirected_to machine_path(assigns(:machine))
  end
